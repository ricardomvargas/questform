...
const LanguagePicker = () => {
  ...
  const [langOptionsLeftPosition, setlangOptionsLeftPosition] =
    useState<number>();
  ...
  const updateMenuLangVisibility = (): void => {
    setlangOptionsLeftPosition(
      getButtonFlagPosition(
        document.getElementById('btn-show-menu-item') as HTMLImageElement
      )
    );
  ...
  return (
    <section className='lang-menu'>
      ...
      <div
        ...
        className={
          langOptionsVisible ? 'lang-menu-options' : 'lang-menu-options-hide'
        }
      >
        <img
          src={ukFlagRounded}
